...
#define APPIRATER_APP_ID				494972250
#define APPIRATER_APP_ID_S              NSLocalizedString(@"a0N30000009i52eEAA", nil)
...
#define APPIRATER_LOCALIZED_RATE_BUTTON_S NSLocalizedString(@"Rate_S %@", nil)
#define APPIRATER_RATE_BUTTON_S			  [NSString stringWithFormat:APPIRATER_LOCALIZED_RATE_BUTTON_S, APPIRATER_APP_NAME]
 ...
 */
#define APPIRATER_DAYS_UNTIL_PROMPT		5		// double days
 ...
 */
#define APPIRATER_USES_UNTIL_PROMPT		5		// integer times
 ...
 */
#define APPIRATER_TIME_BEFORE_REMINDING		5	// double days
